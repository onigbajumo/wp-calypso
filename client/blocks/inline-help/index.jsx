...
const InlineHelpPopover = React.lazy( () => import( 'calypso/blocks/inline-help/popover' ) );

const InlineHelpDialog = React.lazy( () => import( 'calypso/blocks/inline-help/dialog' ) );
